    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-sm animate-fade-in">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-white/[0.06] border border-white/[0.10] mb-5 animate-float">
          ...
          <p className="text-sm text-tertiary font-medium">Options Intelligence Terminal</p>
        </div>

        {/* Card */}
        <div className="surface-2 rounded-2xl p-8 space-y-5">
          <div className="space-y-1.5 mb-2">
            <h2 className="text-lg font-semibold text-white">Sign in</h2>
            <p className="text-sm text-tertiary">Enter your credentials to continue</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-white/[0.06] border border-white/[0.10] rounded-xl px-4 py-2.5 text-sm text-white placeholder:text-disabled focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500/30 transition-all"
                required
                autoFocus
              />
            </div>
          ...
          <p className="text-[11px] text-disabled text-center pt-1 leading-relaxed">
            Your session data is stored locally and never shared.
          </p>
        </div>

        <p className="text-center text-xs text-disabled mt-6">© 2026 Unicron Intelligence Systems</p>
      </div>
    </div>
  )
}
