...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      let earningsDate = $yahoo('span:contains("Next Earnings")').parent().find('span').last().text().trim() ||
                        $yahoo('td:contains("Next Earnings")').next().text().trim() ||
                        $yahoo('span:contains("Earnings Date")').parent().find('span').last().text().trim() ||
                        $yahoo('td:contains("Earnings Date")').next().text().trim()
      ...
      if (!scrapedEarningsDate) {
        ...
        earningsDate = $sa('[data-test="earnings-date"]').text().trim() ||
                      ...
                      $sa('td:contains("Earnings Date")').next().text().trim()
